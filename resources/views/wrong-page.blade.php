...
<head>
  ...
  <link rel="stylesheet" href="{{ generateUrl('/public') }}/error-pages/css/style.css">
...
<body>
  <div class="main w3l">
    ...
    <a href="{{siteURL}}" class="back">BACK TO HOME</a>
    <div class="social-icons w3">
      <ul>
        <li><a class="twitter" href="{{siteURL}}"></a></li>
        <li><a class="facebook" href="{{siteURL}}"></a></li>
        <li><a class="pinterest" href="{{siteURL}}"></a></li>
      </ul>
    </div>
    <div class="footer agileits">
      <p>Copyright © 2016 {{siteURL}}</a></p>
    </div>
  </div>
