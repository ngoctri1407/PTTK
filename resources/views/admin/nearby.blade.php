            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <a style="float: right;" class="btn btn-success manage" data-action="new" type="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<span style="font-size: 13px">New Nearby Facilities</span></a>
                        </div>
                    </div>
