            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <a style="float: right;" class="btn btn-success manage" data-action="new" type="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<span style="font-size: 13px">New Furnished</span></a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <?php
                            if($lstfurnished != null)
                            {
                                $index = 1;
                                foreach ($lstfurnished as $furnished)
                                {
                                    echo "<tr data-id='".$furnished->id."'>";
                                    echo "<td style='vertical-align: middle;'>". $index++ ."</td>";
                                    echo "<td style='vertical-align: middle;'>". $furnished->name_en . "</td>";
                                    echo "<td style='vertical-align: middle;'>". $furnished->name_vi . "</td>";
                                    echo "<td style='text-align: right'><a data-action='edit' style='margin-bottom: 0px' class='btn btn-warning btn-circle btn-outline manage'>
                                                                            ...
                                                                            <a href='amenities/delete/$furnished->id' style='margin-bottom: 0px' class='btn btn-danger btn-circle delete'>
...
@section('page-script')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.save', function () {
            ...
            if($("#nameselected").val() == "")
            {
                Command: toastr["error"]("The name furnished is a required !!!")
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if(data == "ER")
                            {
                                ...
                                Command: toastr["error"]("Furnished already exists !!!")
                            ...
                            if(data == "OK")
                            {
                                Command: toastr["success"]("Add new furnished success !!!")
                ...
                else
                {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if(data == "OK")
                            {
                                Command: toastr["success"]("Update furnished success !!!")
